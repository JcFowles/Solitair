...
/***********************
* GetCardBack: Gets the Card Backing for the game cards
* @author: Callan Moore
* @return: ECardBack: The Enum of back card
********************/
ECardBack CGame::GetCardBack()
{
	return m_eCardBacking;
}
